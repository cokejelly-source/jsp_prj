...
.sunTitle{width: 120px; height: 30px; background-color: #E72203; color: #FFFFFF; font-weight: bold;}
.weekTitle{width: 120px; height: 30px;}
.satTitle{width: 120px; height: 30px; background-color: #5379E1; color: #FFFFFF; font-weight: bold;}

.sunTextColor{color: #E72203;font-size: bold;}
.weekTextColor{color: #909090;}
.satTextColor{color: #5379E1;font-size: bold;}
...
//오늘의 요일을 표현하기 위해서 오늘 정보를 저장한 후 비교한다.
...
if(month != null){//month라는 web paramether가 존재하면
...
//log(selectDay.toString());//selectDay 선택한년, 선택한월
...
%>
<div id="calHeader">
<a href="calendar.jsp?month=<%=nowMonth-1==0? 12:nowMonth-1 %>&year=<%=nowMonth-1==0?nowYear -1 : nowYear%>" title="이전월">&lt;&lt;</a>
<a href="calendar.jsp" title="오늘"><span class="calTitle"><%=nowYear %>.<%=nowMonth %></span>
</a>
<a href="calendar.jsp?month=<%=nowMonth+1==13?1:nowMonth+1%>&year=<%=nowMonth+1==13?nowYear +1:nowYear %>" title="다음월">&gt;&gt;</a>
...
<tbody>
<tr>
<%! //declaration : 선언 - JSP에서 method를 만들거나, istance변수, static변수를 선언할 때 사용
