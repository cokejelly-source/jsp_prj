...
<link rel="shortcut icon" href="${CommonURL }/html_prj/common/images/favicon.ico"/>
<!-- Bootstrap CDN -->
...
<div id="wrap">
    <div id="idDivFrm">
        ...
        if(id != null && !"".equals(id)){
        	...
        	%>
        	입력한 아이디인 <strong style="font-size: 25px"><c:out value="${param.id }"/></strong>는
        	<c:choose>
        	<c:when test="${idFlag }">
        	<span style="font-size: 25px; font-weight: bold; color: #2A5893;">사용 가능</span>
        	한 아이디입니다.<a href="javascript:sendId('${param.id }')">사용</a>
        	</c:when>
        	<c:otherwise>
        	이미<span style="font-size: 25px; font-weight: bold; color: #D94754;"> 사용중</span>입니다.
        	</c:otherwise>
        	</c:choose>
        	<%
