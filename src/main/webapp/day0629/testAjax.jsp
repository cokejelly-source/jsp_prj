...
<body>
	...
	<main>
		...
		<input type="button" class="btn btn-success btn-sm" value="HTML요청" id="btnHTML"/>
		<input type="button" class="btn btn-primary btn-sm" value="TEXT요청" id="btnTEXT"/>
		<input type="button" class="btn btn-primary btn-sm" value="XML요청" id="btnXML"/>
		<input type="button" class="btn btn-info btn-sm" value="JSON요청" id="btnJSON"/>
		</div>
		<select id="subject">
		<option>과목 선택</option>
		</select>
